...
@section('contenido')
                    ...
                    <div class="row mb-2">
                        <div class="col-sm-4">
                            <a class="btn btn-danger mb-2"
                                href="{{ route('empresas.usuarios.create', [Str::slug($empresa->nombre), $empresa->id]) }}"><i
                                    class="mdi mdi-plus-circle me-2"></i> Agregar
                                Usuario</a>
                        </div>
                        <div class="col-sm-8">
                        </div>
    ...
    @include('admin.empresas.usuarios.frmModales')
@endsection
...
@section('js')
    ...
    <script>
        function confirmDelete(userId) {
            const url= "{{ url('admin/empresas/usuarios/destroy') }}"+ '/'+userId;
